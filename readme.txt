Minesweeper Alpha
By: Timmy Iang (UGA ID# 811478161)

All mentioned commands must be called without the surrounding single-quote (').

Assuming one is in the Project1 directory, one can compile the program by using:

'javac -d classes/ src/Minesweeper.java'

After a successful compilation, the program may be ran two ways:

  (1) Using a seed file to denote size of grid, number of mines, and location of the aforementioned mines.
